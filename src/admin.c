...
static bool admin_show_users(PgSocket *admin, const char *arg)
{
	...
	pktbuf_write_RowDescription(
		buf, "siisiiii", "name", "pool_size", "reserve_pool_size", "pool_mode", "max_user_connections", "current_connections",
	...
	statlist_for_each(item, &user_list) {
		...
		pktbuf_write_DataRow(buf, "siisiiii", user->credentials.name,
				     user->pool_size,
				     user->res_pool_size,
				     pool_mode_str,
