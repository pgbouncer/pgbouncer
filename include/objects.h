...
PgPool *get_pool(PgDatabase *, PgAuthInfo *);
...
bool evict_user_connection(PgAuthInfo *user)        _MUSTCHECK;
...
PgAuthInfo *add_global_auth_info(const char *name, const char *passwd) _MUSTCHECK;
PgAuthInfo * add_dynamic_auth_info(PgDatabase *db, const char *name, const char *passwd) _MUSTCHECK;
PgAuthInfo * force_auth_info(PgDatabase *db, const char *username, const char *passwd) _MUSTCHECK;
...
PgAuthInfo * add_pam_auth_info(const char *name, const char *passwd) _MUSTCHECK;
