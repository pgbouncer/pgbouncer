...
{
	total->server_closed_count += stat->server_closed_count;
	...
	total->server_lifetime += stat->server_lifetime;
...
static void calc_average(PgStats *avg, PgStats *cur, PgStats *old)
{
	...
	server_closed_count = cur->server_closed_count - old->server_closed_count;
	...
	if (server_closed_count > 0)
		avg->server_lifetime = (cur->server_lifetime - old->server_lifetime) / server_closed_count;
...
static void write_stats(PktBuf *buf, PgStats *stat, PgStats *old, char *dbname)
{
	...
	pktbuf_write_DataRow(buf, "sNNNNNNNNNNNNNNNNNNNNNNNNN", dbname,
			     stat->server_closed_count,
			     ...
			     stat->wait_time, stat->server_lifetime,
...
bool admin_database_stats(PgSocket *client, struct StatList *pool_list)
{
	...
	pktbuf_write_RowDescription(buf, "sNNNNNNNNNNNNNNNNNNNNNNNNN", "database",
				    "total_server_closed_count",
				    "total_server_assignment_count",
				    "total_xact_count", "total_query_count",
				    "total_received", "total_sent",
				    "total_xact_time", "total_query_time",
				    "total_wait_time", "total_server_lifetime",
...
{
	pktbuf_write_DataRow(buf, "sNNNNNNNNNNNNN", dbname,
			     stat->server_closed_count,
			     stat->server_assignment_count,
			     stat->xact_count, stat->query_count,
			     stat->client_bytes, stat->server_bytes,
...
bool admin_database_stats_totals(PgSocket *client, struct StatList *pool_list)
{
	...
	pktbuf_write_RowDescription(buf, "sNNNNNNNNNNNNN", "database",
				    "server_closed_count",
				    "server_assignment_count",
				    "xact_count", "query_count",
				    "bytes_received", "bytes_sent",
				    "xact_time", "query_time",
				    "wait_time", "server_lifetime",
				    "client_parse_count",
