...
class OpenLDAP:
    ...
    def startup(self):
        print(f"The port is {self.port_lock.port}, the config_dir is {self.config_dir}")
        print(subprocess.run([f"{START_OPENLDAP_SCRIPT}", f"{self.config_dir}", f"{self.port_lock.port}"]))
